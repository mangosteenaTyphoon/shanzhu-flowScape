...
(
    ...
    priority     char         null comment '优先级',
    user_scope   char         null comment '用户范围',
    ...
    release_id   bigint       null comment '发布人id',
    remark       varchar(500) null comment '备注'
)
    comment '系统通知公告表' row_format = DYNAMIC;

INSERT INTO shanzhu_restarts.sys_notice (id, title, type, status, priority, user_scope, content, del_flag, create_id, create_time, update_id, update_time, release_time, release_id, remark) VALUES (1, '如何使用Vditor', '1', '1', '3', '1', 'Vditor 是一款**所见即所得**编辑器，支持 *Markdown*。
...
INSERT INTO shanzhu_restarts.sys_notice (id, title, type, status, priority, user_scope, content, del_flag, create_id, create_time, update_id, update_time, release_time, release_id, remark) VALUES (1842148808657141762, '关于狸花猫', '1', '2', '2', '0', '#### 关于狸花猫
